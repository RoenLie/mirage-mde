 ...
 */
export function createToolbarDropdown(options: any, enabconstooltips: any, shortcuts: Shortcuts, parent: any) {
...
export function extend<T extends object>(...objects: Record<keyof any, any>[]): T {
