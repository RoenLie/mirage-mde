...
import { ToolbarButton, ToolbarDropdownIcon, ToolbarIcon, ToolbarItem } from './types.js';
...
export const bindings: RecordOf<typeof _bindings, string, (editor: EasyMDE2) => void> = _bindings;
...
export const getBindingName = function(f: (editor: EasyMDE2) => any) {
...
export const isMobile = function() {
	let check = false;
	((a) => {
		if (new RegExp('/(android|bb\\d+|meego).+mobile|avantgo|bada\\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge'
			+ ' |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\\.'
			+ '(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(a) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|'
			+ 'a wa|abac|ac(er|oo|s-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)'
			+ '|bl(ac|az)|br(e|v)w|bumb|bw-(n|u)|c55\\/|capi|ccwa|cdm-|cell|chtm|cldc|cmd-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc-s|devi|dica|dmob|do(c|p)o|ds'
			+ '(12|-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(-|_)|g1 u|g560|gene|gf-5|g-mo|go(\\.w|od)|gr(ad|un)|haie|hcit|hd-(m|p|t)'
			+ '|hei-|hi(pt|ta)|hp( i|ip)|hs-c|ht(c(-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i-(20|go|ma)|i230|iac( |-|\\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a'
			+ '|jbro|jemu|jigs|kddi|keji|kgt( |\\/)|klon|kpt |kwc-|kyo(c|k)|le(no|xi)|lg( g|\\/(k|l|u)|50|54|-[a-w])|libw|lynx|m1-w|m3ga|m50\\/|ma(te|ui|xo)|'
			+ 'mc(01|21|ca)|m-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7'
			+ '(0(0|1)|10)|ne((c|m)-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|-([1-8]|c))|phil|pire|pl(ay|uc)|pn-2|po'
			+ '(ck|rt|se)|prox|psio|pt-g|qa-a|qc(07|12|21|32|60|-[2-7]|i-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h-|oo|p-)|sdk\\/|'
			...
			+ '(52|53|60|61|70|80|81|83|85|98)|w3c(-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas-|your|zeto|zte-/i')
			.test(a.substr(0, 4))
		)
			check = true;
	})(
 ...
 * @return The modified HTML text.
 */
export function removeListStyleWhenCheckbox(/** HTML to be modified. */ htmlText: string): string {
 ...
 */
export function toggleFullScreen(editor: EasyMDE2) {
	// Set fullscreen
 ...
 * @param {EasyMDE} editor
 */
export function toggleBold(editor: EasyMDE2) {
 ...
 * @param {EasyMDE} editor
 */
export function toggleItalic(editor: EasyMDE2) {
	console.log(editor.options.blockStyles);
 ...
 * @param {EasyMDE} editor
 */
export function toggleStrikethrough(editor: EasyMDE2) {
 ...
 * @param {EasyMDE} editor
 */
export function toggleCodeBlock(editor: EasyMDE2) {
 ...
 */
export function toggleBlockquote(editor: EasyMDE2) {
 ...
 */
export function toggleHeadingSmaller(editor: EasyMDE2) {
 ...
 */
export function toggleHeadingBigger(editor: EasyMDE2) {
 ...
 */
export function toggleHeading1(editor: EasyMDE2) {
 ...
 */
export function toggleHeading2(editor: EasyMDE2) {
 ...
 */
export function toggleHeading3(editor: EasyMDE2) {
 ...
 */
export function toggleHeading4(editor: EasyMDE2) {
 ...
 */
export function toggleHeading5(editor: EasyMDE2) {
 ...
 */
export function toggleHeading6(editor: EasyMDE2) {
 ...
 */
export function toggleUnorderedList(editor: EasyMDE2) {
	const cm = editor.codemirror;
 ...
 */
export function toggleOrderedList(editor: EasyMDE2) {
 ...
 */
export function cleanBlock(editor: EasyMDE2) {
 ...
 * @param {EasyMDE} editor
 */
export function drawLink(editor: EasyMDE2) {
 ...
 * @param {EasyMDE} editor
 */
export function drawImage(editor: EasyMDE2) {
	const options = editor.options;
	let url = 'https://';
	if (options.promptURLs) {
 ...
 */
export function drawUploadedImage(editor: EasyMDE2) {
 ...
 */
export function afterImageUploaded(editor: EasyMDE2, url: string) {
	const cm = editor.codemirror;
 ...
 * @param {EasyMDE} editor
 */
export function drawTable(editor: EasyMDE2) {
	const cm = editor.codemirror;
	const stat = getState(cm);
	const options = editor.options;
 ...
 * @param {EasyMDE} editor
 */
export function drawHorizontalRule(editor: EasyMDE2) {
	const cm = editor.codemirror;
	const stat = getState(cm);
	const options = editor.options;
 ...
 * @param {EasyMDE} editor
 */
export function undo(editor: EasyMDE2) {
	const cm = editor.codemirror;
	cm.undo();
	cm.focus();
}
 ...
 * @param {EasyMDE} editor
 */
export function redo(editor: EasyMDE2) {
	const cm = editor.codemirror;
	cm.redo();
	cm.focus();
}
 ...
 * @param {EasyMDE} editor
 */
export function toggleSideBySide(editor: EasyMDE2) {
	const cm = editor.codemirror;
	const wrapper = cm.getWrapperElement();
 ...
 * @param {EasyMDE} editor
 */
export function togglePreview(editor: EasyMDE2) {
	const cm = editor.codemirror;
	const wrapper = cm.getWrapperElement();
	const toolbar_div = editor.toolbar_div;
 ...
 * @param {string} url
 */
function _toggleLink(editor: EasyMDE2, type: unknown, startEnd: string, url: string) {
 ...
 * @param {EasyMDE} editor
 */
function _toggleBlock(editor: EasyMDE2, type: unknown, start_chars: string, end_chars?: string) {
	if (!editor.codemirror || editor.isPreviewActive())
		return;
 ...
 */
export function humanFileSize(bytes: number, units: (number | string)[]) {
...
export function extend<T>(target: Record<keyof any, any>, ...args: Record<keyof any, any>[]): T {
	//TODO difficult to get rest params to work, some funky business going on
...
const _toolbarBuiltInButtons: Record<
	string,
	'|' | {name: string; default?: boolean;} | ToolbarButton | ToolbarIcon | ToolbarDropdownIcon
> = {
	'bold': {
		name:      'bold',
		action:    toggleBold,
...
export const toolbarBuiltInButtons: RecordOf<
	typeof _toolbarBuiltInButtons,
	string,
	ToolbarItem
> = _toolbarBuiltInButtons;
